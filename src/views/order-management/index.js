...
function InventoryManagement() {
  ...
  const [serviceProviders, setServiceProviders] = useState([
    { id: 1, orderno: '#58795', customerName: 'James Anderson', amountPaid: '$50', status:"PENDING"   },
    { id: 2, orderno: '#58795', customerName: 'Rikki Carter', amountPaid: '$50', status:"DELIEVRED"  },
    { id: 3, orderno: '#58795', customerName: 'Fiona Parker', amountPaid: '$50', status:"INPROCESS" },
    { id: 4, orderno: '#58795', customerName: 'Fiona Parker', amountPaid: '$50', status:"DISPATCHED" },
  ...
  const columns = [
      ...
      },
    {
      ...
      render: (value, item, index) => (
        <Select
          className={value=="PENDING" ? "color-yellow" : value=="INPROCESS" ? "color-green" : value=="DELIEVRED" ? "color-green" : value=="DISPATCHED" ? "color-pink" : "#000"}
      ...
      render: (item) => (
        <FaEye
          style={{ fontSize: "16px", color: "#C90000",  cursor: "pointer" }}
             onClick={() => navigate("/order-management/" + item )}
        />
      ),
    },
  ];
