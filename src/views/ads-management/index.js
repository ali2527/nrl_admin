...
function InventoryManagement() {
  ...
  const [serviceProviders, setServiceProviders] = useState([
    { id: 1, customerName: 'James Anderson', adTitle: 'ABC Ad Title', isActive: true  },
    { id: 2, customerName: 'James Anderson', adTitle: 'ABC Ad Title', isActive: false  },
    { id: 3, customerName: 'James Anderson', adTitle: 'ABC Ad Title', isActive: false },
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "id",
      render: (item) => (
        <div className="view-link" onClick={() => navigate("/ads-management/" + item )}>View Details</div>
      ),
    },
  ];
  ...
  return (
    <Layout className="configuration">
      ...
      <Row style={{ padding: "10px 20px" }}>
          ...
          >
           <h1 className="pageTitle">Ads Management</h1>
          </Col>
        </Row>
        {/* <Row style={{ padding: "10px 20px" }}>
